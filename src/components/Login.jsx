...
export const Login = () => {
    ...
    return (
        <div style={{ height: newHeight + 'px' }} className="inset-0 flex items-center justify-center bg-[#8b8b8b] bg-opacity-80">
            <div className='border-blur w-full max-w-md h-[400px] rounded-lg flex flex-col bg-white items-center justify-center p-4 space-y-4'>
                    ...
                    <div className='flex p-4 space-x-24'>
                        {isLoading ? (
                          ...
                          focus:outline-none'>
                                ...
                                Verificando<span className="dots"></span>
                            </button>
                        ) : (
                            <button
                                type="submit"
