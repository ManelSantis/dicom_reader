...
export const Annotations = () => {
    return (
        <aside className="h-full w-full sm:w-[40%] lg:w-[30%] xl:w-[20%] flex flex-col">
            <div className="flex-1 w-full overflow-y-auto bg-[#457B9D] pt-6">
                <div className="w-full flex flex-col justify-center items-center pb-6">
                    <h1 className="text-[#F1FAEE] text-[24px] sm:text-[28px] lg:text-[32px] font-bold">Anotações</h1>
                </div>

                <div className="w-full flex flex-col justify-center items-center pb-6">
                    <select
                        id="typeSpecie"
                        className="bg-[#F1FAEE] text-[#2C536B] text-center w-[90%] sm:w-[80%] rounded-md border-[#A8DADC] p-2"
                        name="specie"
                    >
                ...
                <div className="w-full flex flex-col bg-[#457B9D] text-[#F1FAEE] font-[600] p-4 space-y-4">
                    <label
                        ...
                        htmlFor="fileInput"
                        className="w-full flex items-center hover:bg-[#7db0cf] cursor-pointer p-2 rounded"
                    >
                    ...
                    <div className="flex flex-col space-y-4">
                        <button
                            title="Salvar"
                            id="save"
                            className="w-full text-[#F1FAEE] bg-[#457B9D] hover:bg-[#7db0cf] p-2 rounded disabled:opacity-50"
                            disabled
                        >
