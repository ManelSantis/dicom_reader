export const Title = () => {
    ...
    return (
        <div className="w-full h-[15%] bg-[#F1FAEE]">
            <div className="w-full h-[50%] pt-2 flex justify-center">
                <input className="h-[80%] bg-[#F1FAEE] w-full text-[#2C536B]  text-center" type="text" name="" id="title" placeholder="Título do arquivo" />
            </div>
            <div className="w-full h-[50%] pt-2 flex justify-center">
                <div className="w-[50%] h-full flex justify-center">
                    <select className="bg-[#F1FAEE] h-[80%] text-[#2C536B] text-center w-[80%] rounded-md border-2 border-[#A8DADC]" name="specie" id="type">
                ...
                <div className="w-[50%] h-full flex justify-center">
                    <select className="bg-[#F1FAEE] h-[80%] text-[#2C536B] text-center w-[80%] rounded-md border-2 border-[#A8DADC]" name="local" id="part">
